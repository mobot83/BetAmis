...
class MatchTest {
    ...
    void createMatch() {
        ...
        assertEquals(99L, match.getExternalId());
    ...
    void createMatchWithNullId() {
        assertThrows(IllegalArgumentException.class, () -> new Match(null, 0L, "team-1", "team-2", 2, 1, MatchStatus.PLANNED));
    }

    @Test
    @DisplayName("Should throw exception when creating Match with blank id")
    void createMatchWithBlankId() {
        assertThrows(IllegalArgumentException.class, () -> new Match("   ", 0L, "team-1", "team-2", 2, 1, MatchStatus.PLANNED));
    }

    @Test
    @DisplayName("Should throw exception when creating Match with null homeTeamId")
    void createMatchWithNoHomeTeamId() {
        assertThrows(IllegalArgumentException.class, () -> new Match("match-1", 0L, null, "team-2", 2, 1, MatchStatus.PLANNED));
    }

    @Test
    @DisplayName("Should throw exception when creating Match with blank homeTeamId")
    void createMatchWithBlankHomeTeamId() {
        assertThrows(IllegalArgumentException.class, () -> new Match("match-1", 0L, "   ", "team-2", 2, 1, MatchStatus.PLANNED));
    }

    @Test
    @DisplayName("Should throw exception when creating Match with null awayTeamId")
    void createMatchWithNoAwayTeamId() {
        assertThrows(IllegalArgumentException.class, () -> new Match("match-1", 0L, "team-1", null, 2, 1, MatchStatus.PLANNED));
    }

    @Test
    @DisplayName("Should throw exception when creating Match with blank awayTeamId")
    void createMatchWithBlankAwayTeamId() {
        assertThrows(IllegalArgumentException.class, () -> new Match("match-1", 0L, "team-1", "   ", 2, 1, MatchStatus.PLANNED));
    }
    ...
    void createMatchWithNegativeHomeTeamScore() {
        assertThrows(IllegalArgumentException.class, () -> new Match("match-1", 0L, "team-1", "team-2", -1, 1, MatchStatus.PLANNED));
    }
    ...
    void createMatchWithNegativeAwayTeamScore() {
        assertThrows(IllegalArgumentException.class, () -> new Match("match-1", 0L, "team-1", "team-2", 2, -1, MatchStatus.PLANNED));
    }

    @Test
    @DisplayName("Should throw exception when creating Match with null status")
    void createMatchWithNullStatus() {
        assertThrows(IllegalArgumentException.class, () -> new Match("match-1", 0L, "team-1", "team-2", 2, 1, null));
    }

    @Test
    @DisplayName("Should consider two Matches with same id as equal")
    void twoMatchesWithSameIdAreEqual() {
        Match match1 = new Match("match-1", 0L, "team-1", "team-2", 2, 1, MatchStatus.PLANNED);
        Match match2 = new Match("match-1", 0L, "team-1", "team-2", 4, 0, MatchStatus.STARTED);
    ...
    void twoMatchesWithDifferentIdAreNotEqual() {
        Match match1 = new Match("match-1", 0L, "team-1", "team-2", 2, 1, MatchStatus.PLANNED);
        Match match2 = new Match("match-2", 0L, "team-1", "team-2", 2, 1, MatchStatus.PLANNED);
    ...
    void matchNotEqualToDifferentClass() {
        Match match = new Match("match-1", 0L, "team-1", "team-2", 2, 1, MatchStatus.PLANNED);
    ...
    @Test
    @DisplayName("create() factory method should produce a valid PLANNED match")
    void createFactoryMethod() {
        Match match = Match.create("team-1", "team-2");
    ...
    void fromExternalFactoryMethod() {
        ...
        assertNotNull(match.getId());
        assertEquals(42L, match.getExternalId());
    ...
    void withUpdateProducesUpdatedMatch() {
        ...
        assertEquals(10L, updated.getExternalId());
