...
```
prediction-service  →  betamis_predictions  (PostgreSQL)
match-service       →  betamis_matches      (PostgreSQL)
scoring-service     →  betamis_scores       (PostgreSQL)
league-service      →  betamis_leagues      (PostgreSQL)
